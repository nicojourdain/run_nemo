...
# Runs in approx. 5h for 90 days with dt=300s (much more for the 1st iteration)
...
CONFIG='<config>'  ## FULL CONFIG NAME (e.g. "trop075" or "trop075_nest025")
...
CONFEXE='<config>'  # only for nemo.exe
...
NDAYS=95       #- Split year by slices of $NDAYS days 
